"""
Django settings for throbbing_unit_42022 project.
...
ROOT_URLCONF = 'throbbing_unit_42022.urls'
...
WSGI_APPLICATION = 'throbbing_unit_42022.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_unit_42022 API",
    "DESCRIPTION": "API documentation for throbbing_unit_42022 App",
    "VERSION": "v1",
}
